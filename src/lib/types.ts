...
export type EquipmentCategory = 'ZVUK' | 'VIDEO' | 'SVĚTLA' | 'POWER' | 'HARDWARE' | 'INFRASTRUKTURA'
...
export const EQUIPMENT_CATEGORIES: EquipmentCategory[] = ['ZVUK', 'VIDEO', 'SVĚTLA', 'POWER', 'HARDWARE', 'INFRASTRUKTURA']

export const EQUIPMENT_CATEGORY_COLORS: Record<EquipmentCategory, { color: string; bg: string; border: string }> = {
  ZVUK:          { color: '#fbbf24', bg: '#2d2005', border: '#5c4000' },
  VIDEO:         { color: '#38bdf8', bg: '#0a1e2e', border: '#0a3e5c' },
  SVĚTLA:        { color: '#4ade80', bg: '#052e16', border: '#14532d' },
  POWER:         { color: '#fb923c', bg: '#2d1505', border: '#5c2d00' },
  HARDWARE:      { color: '#f87171', bg: '#2d0a0a', border: '#5c1414' },
  INFRASTRUKTURA:{ color: '#a78bfa', bg: '#1a1035', border: '#3d2d6b' },
}
